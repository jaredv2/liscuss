...
export function Landing() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-4xl flex-col items-center justify-center px-4 py-8 text-center sm:px-6">
      <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-7xl">Scrobble Comments</h1>
      <p className="mt-5 max-w-2xl text-base leading-7 text-zinc-400 sm:mt-6 sm:text-lg sm:leading-8">
        Comment on the track you are listening to right now. Timestamped markdown notes are shared with everyone on the track.
      </p>
      <button
